package com.zero.akka.controller;
...
import com.zero.akka.common.actor.ActorNormal;
import com.zero.akka.common.actor.ActorStruct;
...
public class AkkaController {
    ...
    public void AkkaAskStruct() {
        ...
        ActorSystem actorSystem = ActorSystem.create();
        ActorRef actor = actorSystem.actorOf(Props.create(ActorStruct.class,new SystemUserEntity(1,"kiba")), "actorNormal");
