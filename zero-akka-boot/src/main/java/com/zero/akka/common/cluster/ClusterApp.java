...
public class ClusterApp {
    ...
    public static void main(String[] args) {
        ...
        Config configNode1 = ConfigFactory.parseFile(new File(path + "/src/main/resources/node1.conf"))
        ...
        Config configNode2 = ConfigFactory.parseFile(new File(path + "/src/main/resources/node2.conf"))
            .withFallback(ConfigFactory.load());
